...
{
    $data = array($_POST['stname'],$_POST['scname'],$_POST['sdname'],$_POST['simage']);
    $db->recep_send_detail_to_manager($data);


    header("location:Recep.php?select=s");
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" id="simage" name="simage" value=<?php echo $simage?>>
            </div>

            <button type="submit" class="btn btn-dark btn-lg text-white mt-2" id="loginsubmit" style="background-color:midnightblue">Send Detail to Manager</button>
        </form>
    </div>
</div>

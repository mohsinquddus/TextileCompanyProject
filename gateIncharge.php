...
<div class="container my-5">
    <table class="table table-striped" id="myTable">
        ...
        <tr>
            ...
            <th scope="col">Permit Out</th>
        </tr>
        </thead>
        <tbody>
        <?php
        $fetching = $manger->loadAllDataForGateIncharge();
        $i = 0;
        foreach ($fetching as $row) {
            ...
            <td>$row[6]</td>
            <td>
             <a href='GivePermit.php?id=$row[0]' id='permitbtn' onclick=\"return confirm('Are you sure you want to give permit?')\" class='btn btn-primary btn-sm my-1'>Give Exit Permit</a>
            </td>
            </tr>";
            }
            ?>

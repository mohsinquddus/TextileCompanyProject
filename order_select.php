...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    $db->manager_send_detail_to_finance($data);

    header("location:Manager.php?select=u");
...
<div class="jumbotron">
    <div class="container">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-dark btn-lg text-white mt-2" id="loginsubmit" style="background-color:midnightblue">Send Order Detail to Finance Officer</button>
        </form>
    </div>
</div>

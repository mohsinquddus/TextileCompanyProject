...
<head>
    ...
    <title>Finane Officer</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark " style="background-color: midnightblue;">
    <a class="navbar-brand" href="Finance_Officer.php">Finance Officer</a>
...
<div class="container my-5">
    <table class="table table-striped" id="myTable">
        ...
        <tbody>
        <?php
        $fetching = $finance->loadAllDatafromMnager();
        $i = 0;
        foreach ($fetching as $row) {
            ...
            <td>
             ...
             <a href='finance_send_detail_to_dispatch.php?id=$row[0]&name=$row[1]&address=$row[2]&ddate=$row[3]&quantity=$row[4]&ramount=$row[7]&order=$row[8]&payment=$row[9]' class='btn btn-success btn-sm my-1'>Send</a>
             </td>      
        </tr>";
